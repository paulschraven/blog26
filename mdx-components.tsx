...
const components = {
  h1: (props: HeadingProps) => (
    <h1 className="font-semibold pt-12 mb-0 text-gray-300 text-2xl md:text-3xl" {...props} />
  ),
  ...
  a: ({ href, children, ...props }: AnchorProps) => {
    const className =
      'text-gray-300 underline decoration-gray-300 decoration-1 underline-offset-4 hover:decoration-gray-300/50 transition-all duration-200';
    if (href?.startsWith('/')) {
      return (
